<template>
    <div class="captcha-container1">
      ...
      <h2 style="display: flex; justify-content: center; align-items: center;">Select the Images of Flowers</h2>
  ...
  import url1 from "../../assets/images/captcha_img_10.jpeg";
  import url2 from "../../assets/images/captcha_img_15.jpeg";
  import url3 from "../../assets/images/captcha_img_13.jpeg";
  import url4 from "../../assets/images/captcha_img_9.jpeg";
  import url5 from "../../assets/images/captcha_img_12.jpeg";
  import url6 from "../../assets/images/captcha_img_16.jpeg";
  import url7 from "../../assets/images/captcha_img_11.jpeg";
  import url8 from "../../assets/images/captcha_img_14.jpeg";
  import url9 from "../../assets/images/captcha_img_10.1.jpeg";
  ...
  props: {
    ...
    methods: 
    {
      ...
      verifyCaptcha() {
        ...
        setTimeout(() => {
          this.showGif = false;
          this.$router.push('/ImageCaptcha4');
        }, 3000);
        } else {
