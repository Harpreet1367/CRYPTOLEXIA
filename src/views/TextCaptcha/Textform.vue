    ...
    async handleSubmit() {
      if (this.validateForm()) {
        try {
          ...
          await axios.post('https://captchalexia.preetkaur19.com/api/captcha2', {
            username: this.username,
            time_spent: this.totalTextPageTimeSpent,
            number_of_attempts: this.totalTextPageNumberOfAttempts,
...
//alert('Feedback submitted successfully!');        
  ...
  computed: {
    ...mapState({
      totalTextPageTimeSpent: state => state.TextPageTimeSpent,
      totalTextPageNumberOfAttempts: state => state.TextPageNumberOfAttempts,
    }),
    ...
    timeSpent() {
      return this.totalTextPageTimeSpent;
    }
  }
};
</script>
