<template>
    <div class="captcha-container1">
      ...
      <h2 style="display: flex; justify-content: center; align-items: center;">Select the Images of Taxi</h2>
 ...
 import { mapState, mapActions, mapGetters } from 'vuex';
  ...
  import url1 from "../../assets/images/captcha_img_26.jpeg";
  import url2 from "../../assets/images/captcha_img_27.jpeg";
  import url3 from "../../assets/images/captcha_img_30.jpeg";
  import url4 from "../../assets/images/captcha_img_32.jpeg";
  import url5 from "../../assets/images/captcha_img_34.jpeg";
  import url6 from "../../assets/images/captcha_img_33.jpeg";
  import url7 from "../../assets/images/captcha_img_37.jpeg";
  import url8 from "../../assets/images/captcha_img_35.jpeg";
  import url9 from "../../assets/images/captcha_img_31.jpeg";
  ...
  props: {
    ...
    methods: {
      ...
      verifyCaptcha() {
        ...
        setTimeout(() => {
          this.showGif = false; //add this 
          this.$router.push('/Imageform');
        }, 3000);
        } else {
