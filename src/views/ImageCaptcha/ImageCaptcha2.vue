<template>
    <div class="captcha-container1">
      ...
      <h2 style="display: flex; justify-content: center; align-items: center;">Select the Images of Dogs</h2>
  ...
  import url1 from "../../assets/images/captcha_img_1.jpeg";
  import url2 from "../../assets/images/captcha_img_5.jpeg";
  import url3 from "../../assets/images/captcha_img_3.jpeg";
  import url4 from "../../assets/images/captcha_img_8.jpeg";
  import url5 from "../../assets/images/captcha_img_6.jpeg";
  import url6 from "../../assets/images/captcha_img_7.jpeg";
  import url7 from "../../assets/images/captcha_img_4.jpeg";
  import url8 from "../../assets/images/captcha_img_1.1.jpeg";
  import url9 from "../../assets/images/captcha_img_2.jpeg";
  ...
  props: {
    ...
    methods: {
      ...
      verifyCaptcha() {
        ...
        setTimeout(() => {
          this.showGif = false;
          this.$router.push('/ImageCaptcha3');
        }, 3000);
        } else {
