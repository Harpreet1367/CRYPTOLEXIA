    ...
    async handleSubmit() {
      if (this.validateForm()) {
        try {
          ...
          await axios.post('https://captchalexia.preetkaur19.com/api/captcha3', {
            username: this.username,
            time_spent: this.totalAudioPageTimeSpent,
            number_of_attempts: this.totalAudioPageNumberOfAttempts,
...
//alert('Feedback submitted successfully!');
  ...
  computed: {
    ...mapState({
      totalAudioPageTimeSpent: state => state.AudioPageTimeSpent,
      totalAudioPageNumberOfAttempts: state => state.AudioPageNumberOfAttempts,
    }),
    ...
    timeSpent() {
      return this.totalAudioPageTimeSpent;
    }
  }
};
</script>
