...
export default {
    ...
    async handleSubmit() {
      if (this.validateForm()) {
        try {
          ...
          await axios.post('https://captchalexia.preetkaur19.com/api/captcha1', {
            username: this.username,
            time_spent: this.totalImagePageTimeSpent,
            number_of_attempts: this.totalImagePageNumberOfAttempts,
  ...
  computed: {
    ...mapState({
      totalImagePageTimeSpent: state => state.ImagePageTimeSpent,
      totalImagePageNumberOfAttempts: state => state.ImagePageNumberOfAttempts,
    }),
    ...
    timeSpent() {
      return this.totalImagePageTimeSpent;
    }
  }
};
</script>
