<template>
    <div class="captcha-container1">
      ...
      <h2 style="display: flex; justify-content: center; align-items: center;">Select the Images of Traffic Lights</h2>
  ...
  import url1 from "../../assets/images/captcha_img_21.jpeg";
  import url2 from "../../assets/images/captcha_img_22.jpeg";
  import url3 from "../../assets/images/captcha_img_26.jpeg";
  import url4 from "../../assets/images/captcha_img_27.jpeg";
  import url5 from "../../assets/images/captcha_img_23.jpeg";
  import url6 from "../../assets/images/captcha_img_24.jpeg";
  import url7 from "../../assets/images/captcha_img_25.jpeg";
  import url8 from "../../assets/images/captcha_img_28.jpeg";
  import url9 from "../../assets/images/captcha_img_29.jpeg";
  ...
  props: {
    ...
    methods: {
      ...
      verifyCaptcha() {
        ...
        setTimeout(() => {
          this.showGif = false;
          this.$router.push('/ImageCaptcha5');
        }, 3000);
        } else {
